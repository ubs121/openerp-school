...
db_form = u'''<?xml version="1.0"?>
            <form string="'ДБ-5' маягт хэвлэх">
                <separator string="Удирдах ажилтан, багш" colspan="4" />
...
class wizard_db_5(wizard.interface):
    ...
    states = {
        ...
        'report': {
            'actions': [],
            'result': {'type':'print', 'report':'db_5', 'state':'end'}
        },
    }
wizard_db_5('db_5.report')
