...
db_form = u'''<?xml version="1.0"?>
            <form string="'ДБ-2' маягт хэвлэх">
                <separator string="Суралцагчдын сургалтын зардал, хангамж" colspan="4" />
...
db_fields = {
    ...
    'study_type': {'string': u'Сургалтын хэлбэр', 'type':'selection', 'selection':[
                    ('normal', u'Өдөр'),
                    ('ext', u'Орой'),
...
class wizard_db_2(wizard.interface):
    ...
    states = {
        ...
        'report': {
            'actions': [],
            'result': {'type':'print', 'report':'db_2', 'state':'end'}
        },
    }
wizard_db_2('db_2.report')
