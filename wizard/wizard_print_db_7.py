...
db_form = u'''<?xml version="1.0"?>
                <form string="'ДБ-7' маягт хэвлэх">
                    <separator string="Суралцагчдын орон нутгийн харьяалал" colspan="4" />
...
class wizard_db_7(wizard.interface):
    ...
    states = {
        ...
        'report': {
            'actions': [],
            'result': {'type':'print', 'report':'db_7', 'state':'end'}
        },
    }
wizard_db_7('db_7.report')
