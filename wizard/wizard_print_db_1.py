...
<form string="'ДБ-1' маягт хэвлэх">
    <separator string="Суралцагчид (мэргэжил,анги,хүйсээр)" colspan="4" />
...
class wizard_db_1(wizard.interface):
    ...
    states = {
        ...
        'report': {
            'actions': [],
            'result': {'type':'print', 'report':'db_1', 'state':'end'}
        },
    }
wizard_db_1('db_1.report')
