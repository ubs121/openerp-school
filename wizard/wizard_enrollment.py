...
dip_form = u'''<?xml version="1.0"?>
            <form string="Оюутны бүртгэлийн мэдээлэл хэвлэх">
...
class wizard_enrollment(wizard.interface):
    ...
    states = {
        ...
        'report': {
            'actions': [],
            'result': {'type':'print', 'report':'enrollment', 'state':'end'}
        },
    }
wizard_enrollment('enrollment.report')
